    ...
    def init = { servletContext ->
        ...
        new Project(title: "Nonogram Solver",
                ...
                description: "While studying information technology at FHNW, I also wanted to create a Nonogram " +
                        ...
                        "Technologies used: Java, Processing 3",
        ...
        save(new Project(title: "webeC project",
                description: "This is a web project, which I realized in class at FHNW. This was a single person " +
                        "assignment, so all work you see here is from me. \n" +
